...
function dropElements(arr, func) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        if (!func(arr[i])) {
            ...
            // In order to prevent the for loop from skipping the next element in the array we decrement i every time a removal is done. 
    ...
    }   // in a situation where all elements passed into func return false, they have all been removed and there is now an empty arr, we return arr.
    return arr;
